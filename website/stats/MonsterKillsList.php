				...
				<div class="container">
					<div class="row main-row">
						...
						<div class="10u 12u(mobile) important(mobile)">
									...
									$args = '';
									$result = c_mysqli_call($dbLink, "stats_monster_ListByKills", $args);
									...
									{	
										$countDivisor = 3;
										$count = 1;
										echo '<BR><H2>Monster Popularity by Kills in past week:</H2><div style="overflow-x:auto;"><table class="bacon">';
										echo '<tr><th>Rank</th><th>Monster</th><th>% of Total</th></tr>';
